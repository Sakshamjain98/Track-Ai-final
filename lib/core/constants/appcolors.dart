...
class AppColors {
  ...
  static const Color kCardColor = Color(0xFFF8F9FA);
  static const Color kCardColorDarker = Color(0xFFE9ECEF);
  static const Color kTextColor = Color(0xFF212529);
  static const Color kTextSecondaryColor = Color(0xFF6C757D);
  static const Color kAccentColor = Color(0xFF131212);
  static const Color kSuccessColor = Color(0xFF28A745);
  static const Color kWarningColor = Color(0xFFFFC107);
  static const Color kDangerColor = Color(0xFFDC3545);
